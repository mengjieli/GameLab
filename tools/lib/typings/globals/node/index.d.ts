...
// use the es6.d.ts that is bundled with TypeScript 1.8.
interface MapConstructor { }
interface WeakMapConstructor { }
interface SetConstructor { }
interface WeakSetConstructor { }

// Forward-declare needed types from es2015.d.ts (in case users are using `--lib es5`)
...
declare module "zlib" {
    ...
    export interface ZlibOptions {
      flush?: number; // default: zconstants.Z_NO_FLUSH
      finishFlush?: number; // default: zconstants.Z_FINISH
